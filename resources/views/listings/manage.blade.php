        ...
        <table class="w-full table-auto rounded-sm">
            <tbody>
                @unless ($listings->isEmpty())
                    ...
                    <td class="px-4 py-4 border-t border-b border-gray-300 text-lg">
                        <img class="w-12 mr-6 mb-6" src="{{$listing->logo ? asset('storage/'. $listing->logo) : asset('images/no-image.png')}}" alt="" />
                    </td>
                    <td class="px-4 py-4 border-t border-b border-gray-300 text-lg">
                ...
                <tr class="border-gray-300">
                    <td class="px-4 py-8 border-t border-b border-gray-300 text-lg">No Listing Found....</td>
